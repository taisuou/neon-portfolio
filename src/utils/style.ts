...
export const font = {
  replica: {
    hero: 'font-family:replica; font-weight: 700; font-size: calc(3rem + ((1vw - 0.2rem) * 4.4444)); min-height: 0vw; line-height: 1.3;',
    h1: 'font-family:replica; font-weight: 700; font-size: calc(2rem + ((1vw - 0.2rem) * 2.6667)); min-height: 0vw;line-height: 1.1;',
    h2: 'font-family:replica; font-weight: 700; font-size: 2rem; line-height: 1.3;',
    h3: 'font-family:replica; font-weight: 700; font-size: 1.4rem; line-height: 1.3;',
    ...
    // button: 'font-family:replica; font-weight: 700; font-size: 1rem; line-height: 1rem;',
    // caption: 'font-family:replica; font-weight: 400; font-size: 12px; line-height: 1.5;',
    label: 'font-family:replica; font-weight: 700; font-size: 14px; line-height: 1;',
  ...
  Inter: {
    ...
    subtitle1: 'font-family:Inter; font-weight: bold; font-size: 14px; line-height: 1.3;',
    // subtitle2: 'font-family:Inter; font-weight: normal; font-size: 16px; line-height: 1.3;',
    body1: 'font-family:Inter; font-weight: bold; font-size: 14px; line-height:  1.3;',
    body2: 'font-family:Inter; font-weight: normal; font-size: 12px; line-height:  1.3;',
    ...
    button: 'font-family:Inter; font-weight: bold; font-size: 16px; line-height: 1.2;',
