...
export const contents = {
  // meta: {
  //   title: 'Taisho Ichikawa',
  //   description: `Taisho Ichikawa Art Works`,
  ...
  works: [
    ...
    {
      id: 14,
      titleEn: '"Diffusion" Solo Exhibition @DiEGO omotesando',
      ...
      pjinfo: 'exhibition',
      descriptionEn:
        '"Stable diffusion" is one of the image-generating AI models. In Stable diffusion, a model called the diffusion model is used. It is a program that gradually removes noise from noisy images to create clean ones. When illuminating neon tubes, it is necessary to create a high vacuum inside the tube, and the pump used at that time is called a "diffusion pump." Heated oil vaporizes, and high vacuum is obtained due to its movement. Diffusion in each context is a completely different function. However, the word "diffusion" connects the subtle phenomena and mystique that are occurring in both cases. Also, I was intrigued by the various meanings of "diffusion" and poetic associations such as particles dissipating into nothingness. In this exhibition, based on images generated by Stable diffusion, we will present neon artworks expressing the phenomenon of "diffusion" inherent in neon signs and their poetic nuances through a new approach.',
      descriptionJp:
        '画像生成AIの一つである「Stable diffusion」。table diffusionでは、diffusion Model(拡散モデル）と呼ばれるモデルが使われています。ノイズ画像から少しづつノイズを取り除き、綺麗な画像を制作するプログラムです。ネオン管を光らせる際には、管の中に高真空を作る必要がありますが、その時に用いるポンプは「拡散ポンプ」と呼ばれます。熱した油が蒸気となり、その運動によって高い真空度が得られます。それぞれの文脈における拡散は、機能は全く違うものです。が、両者で起こっている微細な現象と神秘性が「拡散」という言葉でつながっていること。また、「拡散」が用いられる多様な意味、粒子となって立ち消えていくといった詩的な連想に興味をかきたてられました。本展では、Stable diffusionで生成した「neon art」の画像を元に、ネオンサインで必然的に扱う光を「拡散」する現象と詩的なニュアンスを通し、新たなアプローチで表現したネオン作品を発表いたします。',
      images: [
        '/images/posts/2023_diffusion/2023_diffusion_00.jpg',
        '/images/posts/2023_diffusion/2023_diffusion_01.jpg',
        '/images/posts/2023_diffusion/2023_diffusion_02.jpg',
        '/images/posts/2023_diffusion/2023_diffusion_03.jpg',
        '/images/posts/2023_diffusion/2023_diffusion_04.jpg',
